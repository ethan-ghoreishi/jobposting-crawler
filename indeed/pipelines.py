...
class SqlInsert(object):
    ...
    def process_item(self, item, spider):
        ...
        try:
            self.c.execute('''insert into jobs (job_title, link_url, location, company, summary, src, found_date, source_url, source_page_body, crawl_timestamp, crawl_url) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)''', (item['job_title'][0], 
	item['link_url'][0], 
	item['location'][0], 
	item['company'][0],
	item['summary'][0], 
